...
int main()
{
    ...
    { //child process: collect the recived data from the named pipe and display in the terminal
        const char * myfifo = "/tmp/AtoB";  // name the pipe, that is why we call it named pipe, you can access this as long as you have the name
    ...
    {//parent process: collect the user input from the terminal and send via the pipe
        ssize_t nread;
        int fds;
        const char * myfifos = "/tmp/BtoA"; //(2)// name the pipe, should be different
